...
namespace Bar_Restaurante_Los_Dragones.Migrations
{
    ...
    public partial class Orden : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Platos",
                columns: new[] { "Id", "Disponible", "ImagenData", "Nombre", "Precio" },
                values: new object[,]
                {
                    { 1, true, null, "AJI DE GALLINA", 10.00m },
                    { 2, true, null, "CEBICHE", 25.00m },
                    { 3, true, null, "ARROZ CON POLLO", 8.00m }
                });
